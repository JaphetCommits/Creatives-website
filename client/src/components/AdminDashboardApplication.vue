...
.logo {
  width: 140px;
  filter: brightness(0) saturate(100%) invert(16%) sepia(3%) saturate(0%) hue-rotate(203deg) brightness(100%) contrast(96%);
}
...
.stat-card {
  ...
  padding: 22px;
  border-radius: 24px;
  background: linear-gradient(145deg, #e1e1e1 0%, #bdbdbd 100%);
